...
fn create_order(id: u64, side: Side, price: i64) -> Order {
    create_order_with_quantity(id, side, price, 1)
}
...
mod cancel_tests {
    ...
    #[test]
    fn removes_order_from_order_book() {
        let mut order_book = OrderBook::new();
    ...
    #[test]
    fn returns_error_when_order_does_not_exist() {
        let mut order_book = OrderBook::new();
...
mod matching_tests {
    ...
    #[test]
    fn creates_trade_when_prices_cross() {
        let mut order_book = OrderBook::new();
    ...
    #[test]
    fn removes_both_orders_when_fully_matched() {
        let mut order_book = OrderBook::new();
